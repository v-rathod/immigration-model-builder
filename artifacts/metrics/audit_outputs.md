...
**Actual Columns (sample 19):** `case_number`, `case_status`, `received_date`, `decision_date`, `employer_id`, `soc_code`, `area_code`, `employer_country`, `job_title`, `wage_offer_from`, `wage_offer_to`, `wage_offer_unit`, `worksite_city`, `worksite_state`, `worksite_postal`, `is_fulltime`, `source_file`, `ingested_at`, `fiscal_year`
