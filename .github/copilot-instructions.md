...
> 2. **`.github/GUARDRAILS.md`** (this repo) — P2 Meridian project-specific guardrails
...
> 5. **`ARCHITECTURE.md`** (this repo) — P2 technical design
> 6. This file — P2 detailed context
>
